...
public class SpriteSource extends Source
	...
	public short xSize, ySize;	//	ќкей, мы все знаем что картинки размером больше чем 32000 точек на 32000
	public short xHalf, yHalf;	//	точек не существуют. ј если и есть - у нас они не по€в€тс€
	...
	public void draw(Graphics2D graph, int index, int xOff, int yOff, Color filter)
		...
		else{	//	≈сли изображени€ по какой-то причине не готовы - рисуем пустой квадратик.
	...
	public	void load()
		...
		if( temp!=null )
			...
			if( scale )
				...
				counter_x = xFrame/xSize;	//	„исло кадров в строке
				counter_y = yFrame/ySize;	//	„исло кадров в столбце
				set=true;
				}
