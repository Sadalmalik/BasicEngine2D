...
version 0.1.07 -> 0.2.01:
 ...
 - Я в серьёз задумываюсь о том что я зря вводил приведение координат. Это вынуждает писать лишние рассчёты повсюду!
 
   Возможно в следующем релизе это будет удалено. При этом так же отпадёт надобность в GraphicsWrap. Бритва Оккама.
